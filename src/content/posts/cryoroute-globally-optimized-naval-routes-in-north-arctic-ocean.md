---
title: "CryoRoute - Globally Optimized Naval Routes in North Arctic Ocean"
description: "Globally optimized naval routes in the North Arctic Ocean from Earth observation data: undergraduate research project."
date: 2019-02-01
cover: "/media/covers/cryoroute-globally-optimized-naval-routes-in-north-arctic-ocean.webp"
tags: ["Earth Observation", "Optimization", "Research"]
---

CryoRoute is a software package developed by the University of Windsor Space & Aeronautics Team (WinSAT), made to generate an optimal route for naval vessels traveling through the Arctic ocean with varied sea ice thickness (SIT).

<figure class="figure-float">
  <img src="/media/cryoroute-globally-optimized-naval-routes-in-north-arctic-ocean/img00.jpg" alt="Arctic sea ice thickness map derived from CryoSat-2 data, in metres" />
  <figcaption>Sea ice thickness map derived from CryoSat-2 data (CPOM)</figcaption>
</figure>
