---
title: "ADCS Fault Detection and Isolation with Ensemble Machine Learning Techniques"
description: "Satellite ADCS fault detection and isolation using ensemble machine learning techniques."
date: 2019-07-05
cover: "/media/covers/adcs-fault-detection-and-isolation-with-ensemble-machine-learning-techniques.webp"
tags: ["Machine Learning", "ADCS", "Research"]
highlight: "Published in the Aerospace Systems journal"
highlightHref: "https://link.springer.com/article/10.1007/s42401-020-00046-x"
---

![](/media/adcs-fault-detection-and-isolation-with-ensemble-machine-learning-techniques/img00.jpg)

Proposed FDI simulation setup

**Published in** [***Aerospace Systems***](https://link.springer.com/article/10.1007/s42401-020-00046-x)***:*** Rahimi, A., & **Saadat, A.** (March, 2020). Fault isolation of reaction wheels onboard three-axis controlled in-orbit satellite using ensemble machine learning. Aerospace Systems, 3(2), 119-126. [doi.org/10.1007/s42401-020-00046-x](https://doi.org/10.1007/s42401-020-00046-x)

**Accepted to** [**IAC 2020**](https://iafastro.directory/iac/paper/id/61254/summary/)**:** Folami, F.O., Rahimi, A. & **Saadat, A.** (March, 2020). Fault Isolation of Reaction Wheels on-board 3-axis Controlled in-orbit Satellite Using Machine Learning Techniques. IAC-20.B4.9-GTS.5.10, *International Astronautical Congress 2020* , Dubai (Online), United Arab Emirates [**[PDF]**](https://www.researchgate.net/publication/344676787_Fault_Isolation_of_Reaction_Wheels_onboard_3-axis_Controlled_in-orbit_Satellite_Using_Machine_Learning_Techniques)
